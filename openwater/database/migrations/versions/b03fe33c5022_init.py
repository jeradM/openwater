...
Revision ID: b03fe33c5022
Revises: 
Create Date: 2020-06-21 09:02:34.175822
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("open_offset", sa.Integer(), nullable=True),
        sa.Column("close_offset", sa.Integer(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("repeat_until", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["program_id"],
            ["program.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["step_id"],
            ["program_step.id"],
            name=op.f("fk_program_step_zones_step_id_program_step"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["zone_id"],
            ["zone.id"],
            name=op.f("fk_program_step_zones_zone_id_zone"),
            ondelete="CASCADE",
        ),
        sa.UniqueConstraint(
            "step_id", "zone_id", name=op.f("uq_program_step_zones_step_id")
        ),
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("program_step_zones")
